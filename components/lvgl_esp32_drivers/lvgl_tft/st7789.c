...
void st7789_init(void)
{
    lcd_init_cmd_t st7789_init_cmds[] = {
        ...
        {ST7789_GCTRL,   {0x35}, 1},
        {ST7789_VCOMS,   {0x28}, 1},  // JLX240 display datasheet
        {ST7789_LCMCTRL, {0x0C}, 1},
        {ST7789_VDVVRHEN,{0x01, 0xFF}, 2},
        {ST7789_VRHS,    {0x10}, 1},      // voltage VRHS
        {ST7789_VDVSET,  {0x20}, 1},
        {ST7789_FRCTR2,  {0x0f}, 1},      // 0x0f=60Hz
        {ST7789_PWCTRL1, {0xa4, 0xa1}, 2},
        {ST7789_RAMCTRL, {0x00, 0xC0}, 2},
        ...
        {ST7789_SLPOUT,  {0}, 0x80},    // Exit sleep mode
        {ST7789_IDMOFF,  {0}, 0x80},
    ...
    ESP_LOGD(TAG, "ST7789 initialization.");
...
void st7789_flush(lv_disp_drv_t * drv, const lv_area_t * area, lv_color_t * color_map)
{
    ...
    ESP_LOGW(TAG, "Flush block：%d-%d， %d-%d.", offsetx1, offsetx2, offsety1, offsety2);
    // ESP_LOGW(TAG, "Data symple：0x%02X, 0x%02X.", data[5], data[20]);
