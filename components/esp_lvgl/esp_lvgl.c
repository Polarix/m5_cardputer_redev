...
#define LCD_PIN_DAT         35
#define LVLCD_PIN_DC        34
#define LVLCD_PIN_RST       33
#define LVLCD_PIN_CS        37
#define LVLCD_PIN_BL        38
...
void esp_lvgl_adapter_init(void)
{
    ...
    gpio_config_t bk_gpio_config = {
        ...
        .pin_bit_mask = 1ULL << LVLCD_PIN_BL
    };
    ...
    lv_color_t *buf1 = heap_caps_malloc(LVGL_DISP_H_RES * LVGL_DISP_BUF_LINE * sizeof(lv_color_t), MALLOC_CAP_DMA);
    assert(buf1);
    lv_color_t *buf2 = heap_caps_malloc(LVGL_DISP_H_RES * LVGL_DISP_BUF_LINE * sizeof(lv_color_t), MALLOC_CAP_DMA);
    assert(buf2);
